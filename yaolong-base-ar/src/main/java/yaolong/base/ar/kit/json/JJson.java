...
public class JJson extends Json {
	...
	public static void setDefaultConvertDepth(int defaultConvertDepth) {
		...
		JJson.defaultConvertDepth = defaultConvertDepth;
	}

	public JJson setConvertDepth(int convertDepth) {
		if (convertDepth < 2) {
	...
	public JJson setTimestampPattern(String timestampPattern) {
	...
	public <T> T parse(String jsonString, Class<T> type) {
		throw new RuntimeException("jfinal " + Const.JFINAL_VERSION
